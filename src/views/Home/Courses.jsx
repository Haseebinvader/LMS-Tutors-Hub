    ...
    return (
        <Box sx={{ backgroundColor: '#f2f2f2', py: '30px' }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', m: '20px' }}>
                <Link to='/Courses'>
                    <Button sx={{ px: '20px', py: '16px', fontSize: '13px', fontWeight: 600, backgroundColor: '#fff', color: '#000', transition: 'background-color 0.3s, color 0.3s', '&:hover': { backgroundColor: '#000', color: '#fff' } }}>View All Courses</Button>
                </Link>
            </Box>
